      ...
      <main className="">
       ...
       <section className="bg-primary py-10">
        <div className="max-w-4xl mx-auto px-3">
          <p className='text-center'>Nous avons mis du temps pour préparer ce contenue riche, nous allons une approche de rentre de notion complexe, facile à comprendre. Nous voulons qu’une personne après avoir participer à cette formation de Full-stack developer, soit capable de produire une application de A à Z sans beaucoup de difficultés. Notre Objectif est de créer de meilleurs développeurs Full-stack indépendant.</p>
        <Image src="/assets/images/affiche3.jpg" alt="" width={1658} height={469} className="mt-10"/>
        </div>
       </section>
      </main>
