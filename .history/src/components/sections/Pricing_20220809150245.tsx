          ...
          <div className="max-w-md mx-auto lg:max-w-5xl">
            <div className="border-l-8 border-l-primary bg-gray-900 px-6 py-8 sm:p-10 lg:flex lg:items-center">
              <div className="flex-1">
                ...
                Nous offrons aux 10 premiers inscrits une <span className="font-bold text-primary">réduction de 15$</span> à chaque personne qui va s’inscrire à la formation en ligne avant le 25 Août. Soit 60$ cash.
                </div>
              </div>
