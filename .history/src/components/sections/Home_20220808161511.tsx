    ...
    <div className="max-w-7xl mx-auto px-3 sm:px-6">
      <div className="grid md:grid-cols-2 gap-6">
        <div>
          ...
          <p className="text-xl">
            Ce Boot camp c’est une machine pour vous transformer en un
            Développeur Full-Stack, vous aller apprends plusieurs notions
            difficiles de trouver à nos universités. Avec 6 projets réels a
            developer j’espère que vous allez aimer l’aventure. Notre équipe
            d’innov prépare déjà les séances avec totale concentration, dans le
