  ...
  return (
    <article className="max-w-3xl mx-auto px-3 sm:px-6">
      <blockquote className="bg-gray-900 border-l-8 border-l-primary text-gray-100 p-4">
        ...
        Nous avons mis du temps à préparer un contenue riche. Nous avons appliqué une approche de rendre des notions complexes, faciles à comprendre. Nous voulons qu’une personne après avoir participer à cette formation puisse etre capable de produire une application de A à Z sans beaucoup de difficultés. Notre Objectif est de créer de meilleurs développeurs Full-stack indépendant.
      </blockquote>
      {/* Chapter 1 */}
      <div className="mt-6">
