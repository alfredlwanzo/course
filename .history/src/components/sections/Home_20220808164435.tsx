    ...
    <div className="max-w-7xl mx-auto px-3 sm:px-6">
      <div className="grid md:grid-cols-2 gap-10 lg:gap-0">
        <div>
          ...
          <div className="mt-9">
            <a href="https://wa.me/+243978154329" target="_blank" rel="noreferrer" className="bg-black text-primary py-4 px-10 text-xl font-semibold rounded-full border-4 border-gray-800 hover:bg-opacity-95">
