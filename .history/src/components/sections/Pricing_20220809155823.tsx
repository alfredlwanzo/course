...
const tiers = [
  ...
  },
  {
    ...
    href: 'https://wa.me/+243978154329',
    price: 100,
    description: 'Nous ne recevrons que 5 personnes au sein de nos locaux à Butembo',
  },
]
  ...
  return (
    <div className="bg-gray-900">
      ...
      <div className="mt-8 pb-12 bg-gray-50 sm:mt-12 sm:pb-16 lg:mt-16 lg:pb-24">
        ...
        <p>Vous pouvez faire un virement Bancaire soit Illico-cash soit airtel-money soit payer du cash a notre Bureau d’innov chez kidubai</p>
