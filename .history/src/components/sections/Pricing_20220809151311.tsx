            ...
            <div className="border-l-8 border-l-primary bg-gray-900 px-6 py-8 sm:p-10 lg:flex lg:items-center">
              ...
              <div className="mt-6 rounded-md shadow lg:mt-0 lg:ml-10 lg:flex-shrink-0">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center justify-center animate-ping px-5 py-3 border border-transparent text-base font-medium rounded-full text-gray-900 bg-white hover:bg-gray-50"
                >
