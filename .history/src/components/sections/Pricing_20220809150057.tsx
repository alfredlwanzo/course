      ...
      <div className="pt-12 sm:pt-16 lg:pt-24">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto space-y-2 lg:max-w-none">
            <h2 className="text-lg leading-6 font-semibold text-gray-300 uppercase tracking-wider">Tarif</h2>
          ...
          <div className="max-w-md mx-auto lg:max-w-5xl">
            <div className="border-l-8 border-l-primary bg-gray-900 px-6 py-8 sm:p-10 lg:flex lg:items-center">
              <div className="flex-1">
                ...
                Nous offrons aux 10 premiers inscrits une <span className="font-bold text-primary">réduction de 15$</span> à chaque personne qui va s’inscrire à la formation en ligne avant le 25 Aout. Donc il paye 60$ cash.
                </div>
              </div>
              <div className="mt-6 rounded-md shadow lg:mt-0 lg:ml-10 lg:flex-shrink-0">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-full text-gray-900 bg-white hover:bg-gray-50"
                >
