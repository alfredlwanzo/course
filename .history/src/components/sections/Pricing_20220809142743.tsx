      ...
      <div className="mt-8 pb-12 bg-gray-50 sm:mt-12 sm:pb-16 lg:mt-16 lg:pb-24">
        ...
        <div className="mt-4 relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 lg:mt-5">
          <div className="max-w-md mx-auto lg:max-w-5xl">
            <div className="rounded-lg bg-primary px-6 py-8 sm:p-10 lg:flex lg:items-center">
              <div className="flex-1">
                ...
                Nous offrons aux 10 premiers inscrits une <span>réduction de 15$</span> à chaque personne qui va s’inscrire à la formation en ligne avant le 25 Aout. Donc il paye 60$ cash.
                </div>
              </div>
