  ...
  return (
    <article className="max-w-3xl mx-auto px-3 sm:px-6">
      ...
      <blockquote className="border-l-8 border-l-primary p-6 mt-6 bg-gray-100 text-gray-700">
        Avec 6 projets réels à développer, nous espèrons que vous allez aimer
        l’aventure. <span className="font-comfortaa font-bold">Innov</span>{" "}
        (notre équipe) prépare les séances avec totale concentration, dans le
      ...
      <div className="mt-6">
        <h2 className="text-3xl font-medium">
          Chapitre 4. Mise en pratique complète, Section de clonage de projets
          existant
        </h2>
        <ul className="list-inside pl-5 mt-4 ">
          <li className="text-xl ">
          ...
          <li className="text-xl ">
            <CheckIcon className="inline-block h-8 w-8 mr-3 text-green-400" />
            Développement d’une application de Gestion commerciale avec Graphql
            avec AWS AppSync
          </li>
          <li className="text-xl ">
            <CheckIcon className="inline-block h-8 w-8 mr-3 text-green-400" />
      ...
      <blockquote className="border-l-8 border-l-primary p-6 mt-6 bg-gray-100 text-gray-700">
        En participant vous aurez{" "}
        <span className="font-bold text-primary">
          accès à une vidéo chaque jour
        </span>{" "}
      ...
      <blockquote className="bg-gray-900 border-l-8 border-l-primary text-xl text-gray-200 p-4">
        ...
        <p>
          Aura droit à une certification, toute personne ayant suivi la formation  à 100% et ayant obtenu 65% aux tests d&apos;évaluation.
